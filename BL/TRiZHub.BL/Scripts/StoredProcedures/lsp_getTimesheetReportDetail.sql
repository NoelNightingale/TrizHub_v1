USE [TRiZHub]
GO
/****** Object:  StoredProcedure [dbo].[lsp_getTimesheetReportDetail]    Script Date: 04/10/2019 08:58:35 ******/
SET ANSI_NULLS ON
GO
...
--exec [lsp_getTimesheetReportDetail] '01-Jan-2016 00:00:00','01-Jan-2017 00:00:00','All','All','''a6459b76-568f-4ee7-b9de-1cfd665e4583'',''5633e637-08e5-4b4e-8598-36bda0e27b18'''
...
set @sql = 'select u.FirstName + '' '' + u.Surname as Contact, ts.DateEntry, c.EntityName Client, p.ProjectNumber, p.ProjectName, pt.Name, p.Billable,
