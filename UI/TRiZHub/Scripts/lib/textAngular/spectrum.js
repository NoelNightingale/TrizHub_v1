    ...
    function paletteTemplate(p, color, className, opts) {
        ...
        for (var i = 0; i < p.length; i++) {
            ...
            if (current) {
                ...
                html.push($("<div />")
                    .append($("<span data-color=\"\" style=\"background-color:transparent;\" class=\"" +
                            cls +
                            "\"></span>")
        ...
        function drawInitial() {
            if (opts.showInitial) {
                ...
                initialColorContainer
                    .html(paletteTemplate([initial, current], current, "sp-palette-row-initial", opts));
            }
        }
