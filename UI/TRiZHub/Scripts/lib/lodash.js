...
(function() {
    ...
    function baseCompareAscending(value, other) {
        if (value !== other) {
            ...
            if ((value > other && !othIsNull) ||
                !valIsReflexive ||
                (valIsNull && !othIsUndef && othIsReflexive) ||
                (valIsUndef && othIsReflexive)) {
                return 1;
            }
            if ((value < other && !valIsNull) ||
                !othIsReflexive ||
    ...
    function runInContext(context) {
        ...
        function baseClone(value, isDeep, customizer, key, object, stackA, stackB) {
            ...
            (isArr ? arrayEach : baseForOwn)(value,
        ...
        function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            if (!isLoose) {
                ...
                if (objIsWrapped || othIsWrapped) {
                    return equalFunc(objIsWrapped ? object.value() : object,
         ...
         * @returns {Function} Returns the new wrapped function.
         */
        function createHybridWrapper(func,
            bitmask,
            thisArg,
            partials,
            holders,
            ...
            function wrapper() {
                ...
                if (isCurry || isCurryRight) {
                    ...
                    if (length < arity) {
                        ...
                        var newData = [
                                func, bitmask, thisArg, newPartials, newsHolders, newPartialsRight, newHoldersRight,
                                newArgPos, ary, newArity
                            ],
        ...
        function equalArrays(array, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            while (++index < arrLength) {
                var arrValue = array[index],
                    ...
                    result = customizer
                        ? customizer(isLoose ? othValue : arrValue, isLoose ? arrValue : othValue, index)
                        : undefined;
        ...
        function equalObjects(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
            ...
            while (++index < objLength) {
                ...
                var objValue = object[key],
                    othValue = other[key],
                    result = customizer
                        ? customizer(isLoose ? othValue : objValue, isLoose ? objValue : othValue, key)
                        : undefined;
        ...
        function transform(object, iteratee, accumulator, thisArg) {
            ...
            (isArr ? arrayEach : baseForOwn)(object,
        ...
        lodash.prototype.run = lodash.prototype.toJSON = lodash.prototype
            .valueOf = lodash.prototype.value = wrapperValue;
