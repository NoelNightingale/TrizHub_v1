            ...
            try {
                return value
                    ...
                    (value == "false"
                        ...
                        : value == "null"
                        ? null
                        : !isNaN(num = Number(value)) ? num : /^[\[\{]/.test(value) ? $.parseJSON(value) : value)
                    : value;
            } catch (e) {
                return value;
            }
    ...
    ParsleyAbstract.prototype = {
        ...
        _findRelatedMultiple: function() {
            return this.parent.$element
                .find("[" + this.options.namespace + 'multiple="' + this.options.multiple + '"]');
        }
    };
/*!
* validator.js
...
var Validator = (function() {
    ...
    Assert.prototype = {
        ...
        */
        ...
        Collection: function(assertOrConstraint) {
            ...
            this.constraint = "undefined" !== typeof assertOrConstraint
                ? (assertOrConstraint instanceof Assert ? assertOrConstraint : new Constraint(assertOrConstraint))
                : false;
    ...
    */
    ...
    // AMD export
    if (typeof define === "function" && define.amd) {
        define("vendors/validator.js/dist/validator",
            [],
            function() {
                return exports;
            });
...
ParsleyUI.prototype = {
    ...
    setupField: function(fieldInstance) {
        ...
        (fieldInstance.options.multiple ? "multiple-" + fieldInstance.options.multiple : fieldInstance.__id__);
    ...
    _insertErrorWrapper: function(fieldInstance) {
        ...
        if ("string" === typeof fieldInstance.options.errorsContainer) {
            if ($(fieldInstance.options.errorsContainer).length)
                ...
                ParsleyUtils.warn("The errors container `" +
    ...
    actualizeTriggers: function(fieldInstance) {
        ...
        $toBind.on(
            ...
            $
            .proxy("function" === typeof fieldInstance.eventValidate ? fieldInstance.eventValidate : this.eventValidate,
                fieldInstance));
    },
...
var ConstraintFactory = function(parsleyField, name, requirements, priority, isDomConstraint) {
    ...
    return $.extend(assert,
    {
        ...
        isDomConstraint: isDomConstraint ||
            ParsleyUtils.checkAttr(parsleyField.$element, parsleyField.options.namespace, name)
    });
};
...
ParsleyField.prototype = {
    ...
    */
    ...
    _bindHtml5Constraints: function() {
        ...
        if ("number" === type) {
            if (("undefined" === typeof this.$element.attr("step")) ||
...
ParsleyFactory.prototype = {
    init: function(options) {
        ...
        (ParsleyUtils.checkAttr(this.$element, this.options.namespace, "validate") &&
    ...
    handleMultiple: function() {
        ...
        if (this.$element.is("select") && "undefined" !== typeof this.$element.attr("multiple")) {
            ...
            ParsleyUtils
                .warn("To be bound by Parsley, a radio, a checkbox and a multiple select input must have either a name or a multiple option.", this.$element);
            return this;
        }
