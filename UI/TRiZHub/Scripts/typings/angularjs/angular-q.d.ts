...
declare namespace Q {
    ...
    interface Promise<T> {
         ...
         */
        spread<U>(onFulfill: (...args: any[]) => IPromise<U> | U, onReject?: (reason: any) => IPromise<U> | U):
        Promise<U>;
         ...
         */
        done(onFulfilled?: (value: T) => any, onRejected?: (reason: any) => any, onProgress?: (progress: any) => any):
        void;
    ...
    export function when<T, U>(value: T | IPromise<T>,
        onFulfilled: (val: T) => U | IPromise<U>,
        onRejected?: (reason: any) => U | IPromise<U>,
        onProgress?: (progress: any) => any): Promise<U>;
    ...
    export function fbind<T>(method: (...args: any[]) => T | IPromise<T>, ...args: any[]): (...args: any[]) =>
    Promise<T>;
    ...
    */
     ...
     * This is especially useful in conjunction with all.
     */
    export function spread<T, U>(promises: IPromise<T>[],
        onFulfilled: (...args: T[]) => U | IPromise<U>,
        onRejected?: (reason: any) => U | IPromise<U>): Promise<U>;
    ...
    export function Promise<T>(resolver: (resolve: (val: T | IPromise<T>) => void,
        reject: (reason: any) => void,
        notify: (progress: any) => void) => void): Promise<T>;
