...
[
    "ui.bootstrap.collapse", "ui.bootstrap.accordion", "ui.bootstrap.alert", "ui.bootstrap.buttons",
    "ui.bootstrap.carousel", "ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.position",
    "ui.bootstrap.datepicker", "ui.bootstrap.debounce", "ui.bootstrap.dropdown", "ui.bootstrap.stackedMap",
    "ui.bootstrap.modal", "ui.bootstrap.paging", "ui.bootstrap.pager", "ui.bootstrap.pagination",
    "ui.bootstrap.tooltip", "ui.bootstrap.popover", "ui.bootstrap.progressbar", "ui.bootstrap.rating",
    "ui.bootstrap.tabs", "ui.bootstrap.timepicker", "ui.bootstrap.typeahead"
]);
...
angular.module("ui.bootstrap.alert", [])
    ...
    [
        "$scope", "$attrs", "$interpolate", "$timeout", function($scope, $attrs, $interpolate, $timeout) {
...
angular.module("ui.bootstrap.dateparser", [])
    ...
    [
        "$log", "$locale", "orderByFilter", function($log, $locale, orderByFilter) {
            ...
            scrollbarWidth: function() {
                if (angular.isUndefined(SCROLLBAR_WIDTH)) {
                    var scrollElem = angular
                        .element('<div style="position: absolute; top: -9999px; width: 50px; height: 50px; overflow: scroll;"></div>');
...
angular.module("ui.bootstrap.datepicker", ["ui.bootstrap.dateparser", "ui.bootstrap.isClass", "ui.bootstrap.position"])
    ...
    [
        "$scope", "$attrs", "$parse", "$interpolate", "$locale", "$log", "dateFilter", "uibDatepickerConfig",
        ...
        function($scope,
            ...
            angular.forEach(["minDate", "maxDate"],
                function(key) {
                    if ($attrs[key]) {
                        watchListeners.push($scope.$parent.$watch($attrs[key],
                            function(value) {
                                self[key] = value
                                    ? angular.isDate(value)
                                    ? dateParser.fromTimezone(new Date(value), ngModelOptions.timezone)
                                    : new Date(dateFilter(value, "medium"))
                                    : null;
                                self.refreshView();
                            }));
                    } else {
            ...
            angular.forEach(["minMode", "maxMode"],
                function(key) {
                    if ($attrs[key]) {
                        watchListeners.push($scope.$parent.$watch($attrs[key],
                            function(value) {
                                ...
                                if (key === "minMode" &&
                                    self.modes.indexOf($scope.datepickerMode) < self.modes.indexOf(self[key]) ||
                                    key === "maxMode" &&
                                    self.modes.indexOf($scope.datepickerMode) > self.modes.indexOf(self[key])) {
            ...
            if (angular.isDefined($attrs.initDate)) {
                this.activeDate = dateParser.fromTimezone($scope.$parent.$eval($attrs.initDate),
                        ngModelOptions.timezone) ||
                    new Date();
                watchListeners.push($scope.$parent.$watch($attrs.initDate,
                    function(initDate) {
    ...
    [
        "$scope", "$element", "$attrs", "$compile", "$parse", "$document", "$rootScope", "$uibPosition", "dateFilter",
        ...
        function(scope,
            ...
            this.init = function(_ngModel_) {
                ...
                if (scope.datepickerOptions) {
                    angular.forEach(scope.datepickerOptions,
                        function(value, option) {
                            ...
                            if (["minDate", "maxDate", "minMode", "maxMode", "initDate", "datepickerMode"]
                                .indexOf(option) ===
                                -1) {
                                ...
                                function(value) {
                                    if (key === "minDate" || key === "maxDate") {
                                        if (value === null) {
                                            ...
                                            cache[key] = dateParser
                                                .fromTimezone(new Date(value), ngModelOptions.timezone);
                                        } else {
                                        ...
                                        scope.watchData[key] = dateParser
                                            .fromTimezone(new Date(value), ngModelOptions.timezone);
                                    }
                                }));
                ...
                angular.forEach([
                        ...
                        "formatMonthTitle",
                        "showWeeks", "startingDay", "yearRows", "yearColumns"
                    ],
                    function(key) {
            ...
            scope.dateSelection = function(dt) {
                ...
                var date = scope
                    .date
                    ? dateFilter(scope.date, dateFormat)
            ...
            scope.$watch("isOpen",
                function(isOpen, wasOpen) {
                    ...
                    $animate[isOpen ? "addClass" : "removeClass"
                        ](openContainer, appendTo ? appendToOpenClass : openClass)
                        .then(function() {
...
[
    "$animateCss", "$injector", "$uibModalStack",
...
[
    "$uibModalStack", "$q", "$animate", "$animateCss", "$document",
            ...
            create: function(ctrl, $scope, $attrs) {
                ...
                ctrl.init = function(ngModelCtrl, config) {
                    ...
                    if ($attrs.itemsPerPage) {
                        ctrl._watchers.push($scope.$parent.$watch($parse($attrs.itemsPerPage),
                            function(value) {
...
angular.module("ui.bootstrap.datepicker")
    .run(function() {
        !angular.$$csp().noInlineStyle &&
            angular.element(document)
            .find("head")
            .prepend('<style type="text/css">.uib-datepicker .uib-title{width:100%;}.uib-day button,.uib-month button,.uib-year button{min-width:100%;}.uib-datepicker-popup.dropdown-menu{display:block;}.uib-button-bar{padding:10px 9px 2px;}</style>');
    });
angular.module("ui.bootstrap.timepicker")
    .run(function() {
        !angular.$$csp().noInlineStyle &&
