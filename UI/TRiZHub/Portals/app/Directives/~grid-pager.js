...
(function (GridPagerNamespace) {
    var GridPagerDirectiveController = /** @class */ (function () {
    ...
    var gridPager = /** @class */ (function () {
        function gridPager() {
            this.restrict = "E";
            this.templateUrl = "Portals/app/directives/gridPager.html";
            this.controller = GridPagerDirectiveController;
    ...
    angular.module("AngularApp")
        .directive("gridPager", [function () { return new gridPager(); }]);
