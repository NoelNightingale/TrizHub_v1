...
var TeamJobDesignationGridController = /** @class */ (function (_super) {
    __extends(TeamJobDesignationGridController, _super);
    //#endregion
    //#region Ctor
    function TeamJobDesignationGridController($scope, $state, $stateParams, UserService, Popups, tcrGrid) {
        ...
        _this.newRecord = function () {
            _this.$state.transitionTo("mainState.maintenance.userMaintenance.teamJobDesignationtDetail", { userid: _this.viewModel.id, "id": "new" });
        };
        ...
        _this.pageGrid = new TcrGridServiceModule.TcrGridService("client", _this.UserService.teamJobDesignationGrid, _this.onDataLoaded, function (model) {
    ...
    //#endregion
    TeamJobDesignationGridController.prototype.onLoadEvent = function (event) {
        this.gridModel = event;
        this.loadingIsDone = true;
    };
    return TeamJobDesignationGridController;
}(CHControllerBase));
...
//# sourceMappingURL=~TeamJobDesignationGridController.js.map