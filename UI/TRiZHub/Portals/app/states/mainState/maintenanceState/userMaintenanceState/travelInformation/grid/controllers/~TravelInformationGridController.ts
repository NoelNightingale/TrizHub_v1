class TravelInformationGridController extends CHControllerBase {
    ...
    constructor(private $scope: ng.IScope,
        ...
        private TravelInformationService: TravelInformationServiceModule.TravelInformationService,
        ...
        this.pageGrid = new TcrGridServiceModule.TcrGridService(
            "expiryDate",
            this.TravelInformationService.travelInformationGrid,
            this.onDataLoaded,
            model => {
    ...
    newTravelInfo = () => {
        this.$state.transitionTo("mainState.maintenance.userMaintenance.travelInformationDetail",
