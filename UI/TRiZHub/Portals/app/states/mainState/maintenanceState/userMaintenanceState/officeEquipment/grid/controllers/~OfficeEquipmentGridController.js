...
var OfficeEquipmentGridController = /** @class */ (function (_super) {
    __extends(OfficeEquipmentGridController, _super);
    //#endregion
    //#region Ctor
    function OfficeEquipmentGridController($scope, $state, $stateParams, UserService, Popups, tcrGrid) {
        ...
        _this.newOfficeEquipment = function () {
            _this.$state.transitionTo("mainState.maintenance.userMaintenance.officeEquipmentDetail", { userid: _this.viewModel.id, "id": "new" });
        };
        ...
        _this.pageGrid = new TcrGridServiceModule.TcrGridService("assignedDate", _this.UserService.officeEquipmentGrid, _this.onDataLoaded, function (model) {
    ...
    //#endregion
    OfficeEquipmentGridController.prototype.onLoadEvent = function (event) {
        this.gridModel = event;
        if (this.gridModel.totalItems > 0) {
            this.loadingIsDone = true;
        }
    };
    return OfficeEquipmentGridController;
}(CHControllerBase));
...
//# sourceMappingURL=~OfficeEquipmentGridController.js.map