class EmergencyContactGridController extends CHControllerBase {
    ...
    constructor(private $scope: ng.IScope,
        ...
        this.pageGrid = new TcrGridServiceModule.TcrGridService(
            "Name",
            this.UserService.emergencyContactGrid,
            this.onDataLoaded,
            model => {
    ...
    newEmergencyContact = () => {
        this.$state.transitionTo("mainState.maintenance.userMaintenance.emergencyContactDetail",
