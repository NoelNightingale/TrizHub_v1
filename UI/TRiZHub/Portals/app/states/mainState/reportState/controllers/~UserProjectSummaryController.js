...
var UserProjectSummaryController = /** @class */ (function (_super) {
    ...
    function UserProjectSummaryController($stateParams, $scope, $state, $timeout, $window, $filter, UserService, ReportService, SecurityService, AccountService, Popups) {
        ...
        _this.submitForm = function () {
            ...
            self.$window.open(self.ReportService.reportApi() + '/ProjectAllocation' +
                ...
                + "&onlyActiveSubProjects=" + self.viewModel.onlyActiveSubProjects, "_blank");
        };
        var self = _this;
...
//# sourceMappingURL=~UserProjectSummaryController.js.map